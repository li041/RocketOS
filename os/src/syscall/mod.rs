...
use task::{
    sys_clock_nansleep, sys_clone, sys_execve, sys_exit_group, sys_futex, sys_get_robust_list, sys_get_time, sys_getegid, sys_geteuid, sys_getpid, sys_getppid, sys_gettid, sys_getuid, sys_nanosleep, sys_set_robust_list, sys_set_tid_address, sys_setpgid, sys_waitpid, sys_yield
};
...
pub fn syscall(
    ...
    match syscall_id {
        ...
        SYSCALL_GET_ROBUST_LIST => sys_get_robust_list(a0 as i32, a1, a2),
