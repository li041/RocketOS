 ...
 * @LastEditTime: 2025-05-05 10:24:21
 * @FilePath: /RocketOS/os/src/net/udp.rs
...
use super::SOCKET_SET;
 ...
 impl UdpSocket {
    ...
    pub fn bind(&self,mut bind_addr:SocketAddr) {
        ...
        println!("[udp_bind]bind addr is {:?}",bind_addr);
    ...
    pub fn connect(&self,remote_addr:SocketAddr) ->Result<(),Errno>{
        log::error!("[Udpsocket_connect]:begin connect");
