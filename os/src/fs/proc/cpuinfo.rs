...
use crate::{
    ...
    fs::{
        file::{FileOp, OpenFlags}, inode::InodeOp, kstat::Kstat, path::Path, proc, uapi::Whence, FileOld
    },
...
impl FakeCPUInfo {
    ...
    pub fn serialize(&self) -> String {
        ...
        // 基本信息
        result.push_str("processor: "); result.push_str(&self.processor.to_string()); result.push('\n');
        result.push_str("vendor_id: "); result.push_str(&self.vendor_id); result.push('\n');
        result.push_str("cpu_family: "); result.push_str(&self.cpu_family.to_string()); result.push('\n');
        result.push_str("model: "); result.push_str(&self.model.to_string()); result.push('\n');
        result.push_str("model_name: "); result.push_str(&self.model_name); result.push('\n');
        result.push_str("stepping: "); result.push_str(&self.stepping.to_string()); result.push('\n');
        result.push_str("microcode: "); result.push_str(&self.microcode); result.push('\n');
        result.push_str("cpu_mhz: "); result.push_str(&self.cpu_mhz.to_string()); result.push('\n');
        result.push_str("cache_size: "); result.push_str(&self.cache_size.to_string()); result.push('\n');
        result.push_str("physical_id: "); result.push_str(&self.physical_id.to_string()); result.push('\n');
        result.push_str("siblings: "); result.push_str(&self.siblings.to_string()); result.push('\n');
        result.push_str("core_id: "); result.push_str(&self.core_id.to_string()); result.push('\n');
        result.push_str("cpu_cores: "); result.push_str(&self.cpu_cores.to_string()); result.push('\n');
        result.push_str("apicid: "); result.push_str(&self.apicid.to_string()); result.push('\n');
        result.push_str("initial_apicid: "); result.push_str(&self.initial_apicid.to_string()); result.push('\n');
        result.push_str("fpu: "); result.push_str(&self.fpu); result.push('\n');
        result.push_str("fpu_exception: "); result.push_str(&self.fpu_exception); result.push('\n');
        result.push_str("cpuid_level: "); result.push_str(&self.cpuid_level.to_string()); result.push('\n');
        result.push_str("wp: "); result.push_str(&self.wp); result.push('\n');
        ...
        // 其他字段
        result.push_str("bogomips: "); result.push_str(&self.bogomips.to_string()); result.push('\n');
        result.push_str("clflush_size: "); result.push_str(&self.clflush_size.to_string()); result.push('\n');
        result.push_str("cache_alignment: "); result.push_str(&self.cache_alignment.to_string()); result.push('\n');
        result.push_str("address_sizes: "); result.push_str(&self.address_sizes); result.push('\n');
        result.push_str("power_management: "); result.push_str(&self.power_management); result.push('\n');
